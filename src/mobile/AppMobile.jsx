...
function Splash() {
  return <div className="splash"><img src={assetPath('logo.png')} alt="AnimeVault" className="splash-logo" /><div className="splash-title">AnimeVault</div><div className="splash-sub">Your ultimate anime hub</div></div>;
}

function Sidebar({ currentPage, navigate, open, close, user, activeSubAccount, onSwitchAccount }) {
  const sections = [
    { label: 'Browse', items: [{ id: 'home', label: 'Home', icon: Home }, { id: 'search', label: 'Search', icon: Search }, { id: 'dramas', label: 'Shows & Movies', icon: Film }, { id: 'schedule', label: 'Schedule', icon: Calendar }] },
    { label: 'Library', items: [{ id: 'collections', label: 'My List', icon: Heart }, { id: 'notifications', label: 'Notifications', icon: Bell }, { id: 'stats', label: 'Stats', icon: BarChart3 }, { id: 'community', label: 'Community', icon: Users }] },
  ];
  return <>
