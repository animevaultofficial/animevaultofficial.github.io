...
export default function AppMobile() {
  ...
  useEffect(() => {
    try {
      const accent = localStorage.getItem('av_accent') || 'red';
      const theme = localStorage.getItem('av_theme') || 'dark';
      const font = localStorage.getItem('av_font_size') || 'medium';
      applyAccentColor(accent);
      applyTheme(theme, storage.get('customThemeVars'));
      document.documentElement.dataset.avFontSize = font;
    } catch (err) { console.warn('[AnimeVault Mobile] appearance restore failed:', err); }
  }, []);
