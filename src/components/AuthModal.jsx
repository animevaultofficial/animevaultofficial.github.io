...
import { X, User, Lock, Sparkles, AlertCircle, CheckCircle, UserRound } from 'lucide-react';
...
export default function AuthModal() {
  const { showAuthModal, setShowAuthModal, authTab, setAuthTab, login, signup, loginAsGuest, sendVerificationCode, loginWithGoogle } = useUser();
