...
function App() {
  ...
  useEffect(() => {
    // The home route is the primary entry point. Prefetch its chunk immediately so
    // slow mobile networks do not spend a second render cycle waiting on Suspense.
    void import('./pages/MixedHome');
  }, []);
  useEffect(() => {
